...
if ($result1->num_rows > 0) //si la variable tiene al menos 1 fila entonces seguimos con el codigo
{
		...
		*/
		...
		$output.= "\\qc {\\fs32  {\\ul \\b C E R T I F I C A D O S}     \\fs24 (".$iniciales.")} ";
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\qj {\\fs24 CERTIFICO: QUE LA PRESENTE COPIA SE ENCUENTRA CONFORME CON SU MATRIZ.- CHILLAN, ".fecha_certificado($fecha_form).".-}";
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
		...
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\qc {\\fs32  \\ul \\b CERTIFICADO DE INSCRIPCION}";  
		$output.= "\\par ";  //<-- ENTER
		$output.= "\\par ";  //<-- ENTER
