...
<table class="table table-bordered table-hover">
 ...
 <tbody>
  ...
  $res = $conexion->query("select * from hipoteca WHERE folio=$folio");
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel<?php echo $row['id_hipoteca']; ?>">Editar datos</h4>
          </div>
          <div class="modal-body">
            ...
            <form>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="tipo<?php echo $row['id_hipoteca']; ?>" value="<?php echo $row['TIPO']; ?>">
              </div>
              <div class="form-group">
                <label for="nombre">Nombre</label>
                <input type="text" class="form-control" id="nombre<?php echo $row['id_hipoteca']; ?>" value="<?php echo $row['NOMBRE']; ?>">
              </div>
              <?php 
                  if($row['VUELTA']=="v") {
              ...
              <div class="form-inline">
                ...
                <input type="text" class="form-control" id="fojas<?php echo $row['id_hipoteca']; ?>" value="<?php echo $row['FOJAS']; ?>" >
                  <label class="checkbox-inline" for="vuelta">
                    <input type="checkbox" name="vuelta<?php echo $row['id_hipoteca']; ?>" id="vuelta<?php echo $row['id_hipoteca']; ?>" <?php echo $vuelta_check; ?> value="v"/> vuelta
                  </label>

              </div>
              <div class="form-group">
                <label for="numero">Número</label>
                <input type="text" class="form-control" id="numero<?php echo $row['id_hipoteca']; ?>" value="<?php echo $row['NUMERO']; ?>">
              </div>
              <div class="form-group">
                <label for="ano">Año</label>
                <input type="text" class="form-control" id="ano<?php echo $row['id_hipoteca']; ?>" value="<?php echo $row['ANO']; ?>">
              </div>
              <div class="form-group">
                <label for="acreedor">Acreedor...</label>
                <textarea class="form-control" id="acreedor<?php echo $row['id_hipoteca']; ?>" value=""><?php echo $row['ACREEDOR']; ?></textarea>
              </div>
