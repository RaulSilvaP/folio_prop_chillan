...
while ($row = $res->fetch_assoc()) {
  ...
  <tr>
   ...
   <td>
     ...
     <a title="Eliminar" class="btn btn-danger btn-sm" <?php echo $desabilitar; ?> onclick="deletedata_prohibicion('<?php echo $row['id_prohibicion']; ?>')" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" onclick="updatedata_prohibicion('<?php echo $row['id_prohibicion']; ?>')" class="btn btn-primary">Grabar</button>
          </div>
        </div>
      </div>
    </div>
